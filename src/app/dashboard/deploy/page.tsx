    ...
    <div className="p-4 md:p-6 lg:p-8">
      <Card className="max-w-4xl mx-auto shadow-2xl">
        <CardHeader>
          ...
          <CardDescription>
            अपने एप्लिकेशन को फायरबेस होस्टिंग पर लाइव करने के लिए यहां क्लिक
            करें।
          </CardDescription>
        </CardHeader>
        <CardContent className="text-center">
          <div className="p-8 border-dashed border-2 rounded-xl">
            ...
            <Button
              size="lg"
              className="animate-fast-blinking-glow h-14 text-lg"
              disabled
            >
            ...
            <CardHeader className="flex-row items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  यह बटन वर्तमान में केवल एक डेमो है। वास्तविक तैनाती
                  कार्यक्षमता को एक सुरक्षित बैकएंड के माध्यम से लागू किया जाना
                  है। ऐप को डिप्लॉय करने के लिए, टर्मिनल में `npm run deploy`
                  कमांड चलाएँ।
                </p>
              </div>
            </CardHeader>

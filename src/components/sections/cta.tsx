            ...
            <div className="bg-secondary/30 p-8 rounded-2xl shadow-2xl">
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <Button
                  type="submit"
                  size="lg"
                  className="w-full bg-accent text-accent-foreground hover:bg-accent/90 shadow-lg transition-transform duration-200 hover:scale-105"
                  disabled={isLoading}
                >
                  {isLoading ? (
      ...
      <AlertDialog open={isAlertOpen} onOpenChange={setIsAlertOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              आपकी पूछताछ प्राप्त हो गई है। हमारी टीम जल्द ही आपसे संपर्क
              करेगी। धन्यवाद!
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
